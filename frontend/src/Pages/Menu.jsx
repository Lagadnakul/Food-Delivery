...
const Menu = () => {
  const { foodItems, categories, loading, refreshMenu } = useMenu();
      ...
      <div className="container mx-auto px-4">
          ...
          {categories.map((category) => (
            <div key={category}>
              <Button
                ...
                className={`px-6 py-5 rounded-full font-medium ${activeCategory === category
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="relative flex-grow">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                <Search size={18} className="text-gray-400 z-10" />
              </div>
              <Input
                type="text"
                value={searchQuery}
                ...
                className="w-full h-12 pl-11 pr-10 border-gray-200 rounded-xl focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:border-orange-500 transition-all duration-300 bg-gray-50 hover:bg-white focus-visible:bg-white text-base shadow-none"
              />
              {searchQuery && (
                <div className="absolute inset-y-0 right-0 pr-2 flex items-center">
                  <Button
                    ...
                    className="h-8 w-8 text-gray-400 hover:text-orange-500 rounded-full"
                  >
                    <X size={16} />
                  </Button>
                </div>
            ...
            <div className="md:w-auto">
              <Button
                ...
                className="w-full h-12 md:w-auto px-6 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-xl hover:from-orange-600 hover:to-orange-700 transition-all duration-300 flex items-center justify-center gap-2 shadow-md hover:shadow-lg text-base"
              >
                <Filter size={18} />
                <span>Filter</span>
              </Button>
              ...
              <AnimatePresence>
                {isFilterMenuOpen && (
                  <div className="md:hidden absolute left-0 right-0 bg-white mt-2 p-4 rounded-xl shadow-lg z-20 mx-4">
        ...
        {activeCategory !== 'All' && (
          <div className="my-6 text-center">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-orange-400 to-orange-600 mx-auto mt-3 rounded-full"/>
          </div>
        )}
        ...
        <div className="flex justify-center mb-8">
          <div>
            <Button
              variant="outline"
              onClick={refreshMenu}
              className="flex items-center px-6 h-12 rounded-xl shadow-sm hover:text-orange-500 hover:border-orange-200 hover:bg-orange-50 transition-all duration-300 border-gray-200"
              disabled={loading}
            >
            ...
            <AnimatePresence mode="popLayout">
              {filteredItems.map((item) => (
                <div key={item._id || item.id}>
                  <Card className="overflow-hidden border-gray-100 hover:shadow-xl hover:-translate-y-1 hover:border-orange-100 transition-all duration-300 group">
                    ...
                    <div className="p-5">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div>
                          <Button
                            className="px-5 h-10 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-xl text-sm font-medium hover:from-orange-600 hover:to-orange-700 flex items-center gap-2 shadow-md hover:shadow-lg transition-all duration-300"
                            onClick={() => addToCart(item)}
                          >
                            <ShoppingBag size={16} />
                            Add
        ...
        {!loading && filteredItems.length === 0 && (
          <div className="text-center py-16 bg-white rounded-xl shadow-sm max-w-lg mx-auto">
